...
// 角度单位换算
float math::rad2deg(const float& angle) { return angle * 57.2957795f; }

float math::deg2rad(const float& angle) { return angle * 0.01745329f; }
...
float math::rpm2radps(const float& w) { return w * 0.10471976f; }

float math::radps2rpm(const float& w) { return w * 9.54929658f; }

float math::radps2dps(const float& w) { return w * 57.2957795f; }

float math::dps2radps(const float& w) { return w * 0.01745329f; }

float math::rpm2dps(const float& w) { return w * 6.f; }

float math::dps2rpm(const float& w) { return w * 0.16666667f; }
