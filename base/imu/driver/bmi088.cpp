 ...
 ******************************************************************************
 * @file    bmi088.cpp/h
 * @brief   BMI088(6-axis-IMU) driver. BMI088(6轴IMU)驱动
 ******************************************************************************
...
#if (defined CS1_ACCEL_GPIO_Port) and (defined CS1_ACCEL_Pin)
...
// #define BMI088_accel_write_muli_reg( reg,  data, len) { BMI088_ACCEL_NS_L();
// BMI088_write_muli_reg(reg, data, len); BMI088_ACCEL_NS_H(); }
...
// #define BMI088_gyro_write_muli_reg( reg,  data, len) { BMI088_GYRO_NS_L();
// BMI088_write_muli_reg( ( reg ), ( data ), ( len ) ); BMI088_GYRO_NS_H(); }
...
uint8_t bmi088_accel_self_test(void) {
  ...
  for (write_reg_num = 0; write_reg_num < 2; write_reg_num++) {
    ...
    BMI088_accel_read_single_reg(
        write_BMI088_ACCEL_self_test_Reg_Data_Error[write_reg_num + 4][0], res);
    BMI088_delay_us(BMI088_COM_WAIT_SENSOR_TIME);
