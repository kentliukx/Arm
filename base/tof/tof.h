...
//    // 校验接收信息的CAN通道和ID
//    bool canRxMsgCheck(CAN_HandleTypeDef* hcan, CAN_RxHeaderTypeDef
//    rx_header);
//
//    // Receive feedback data message callback. Called in
//    // HAL_CAN_RxFifo0MsgPendingCallback()
//    // 信息接收回调，在HAL_CAN_RxFifo0MsgPendingCallback中调用
//    void canRxMsgCallback(CAN_HandleTypeDef* hcan, CAN_RxHeaderTypeDef
//    rx_header,
//                          uint8_t* rx_data);
//
//    //确认can包ID
...
class TOFSenseDriver {
 public:
  explicit TOFSenseDriver(UART_HandleTypeDef* huart = nullptr,
                          TOF_Sense* sensor1 = nullptr,
                          TOF_Sense* sensor2 = nullptr);
  void rxCallback();
  void init();
